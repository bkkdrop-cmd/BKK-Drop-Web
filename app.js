...
function renderTabs() {
  if (currentView === "admin") {
    $("tabs").innerHTML = `
      ...
      <button class="tab ${adminPage === "billing" ? "active" : ""}" onclick="window.setAdminPage('billing')">Billing</button>
    ...
    $("tabs").innerHTML = `
      ...
      <button class="tab ${customerPage === "billing" ? "active" : ""}" onclick="window.setCustomerPage('billing')">Billing</button>
