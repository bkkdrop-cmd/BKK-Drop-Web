...
function getCloudinaryConfig() {
  const cfg = window.cloudinaryConfig || {};
  return {
    cloudName: cfg.cloudName || "",
    unsignedUploadPreset: cfg.unsignedUploadPreset || ""
  };
}
...
function isCloudinaryConfigured() {
  ...
  return Boolean(
    cfg.cloudName &&
    cfg.unsignedUploadPreset &&
    !cfg.cloudName.includes("PASTE_") &&
    !cfg.unsignedUploadPreset.includes("PASTE_")
  );
}
...
async function uploadImageToCloudinary(file, userId = "unknown", folder = "bkk-drop") {
  if (!isCloudinaryConfigured()) {
    throw new Error("Cloudinary is not configured. Please fill cloudName and unsignedUploadPreset in config.js.");
  }
